...
from conftest import work_login_init
...
class SwaggerForYaml:
    ...
    def yaml_cases(cls, data: Dict, file_path: str) -> None:
        ...
        try:
            ...
            ...
        _file_path = _dir_path + ("_".join(file_path.split("/")[1:])) + ".yaml"
        with open(_file_path, "w", encoding="utf-8") as file:
            yaml_file = YAML()
            yaml_file.dump(data, file)
            file.write('\n')

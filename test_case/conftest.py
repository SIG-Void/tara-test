...
def work_login_init():
    ...
    url = "https://sigvoid.hk/tara/login"
    data = {
        "email": "lt15191796518@163.com",
        "password": "Sigvoid123"
    }
    ...
    response_cookie = res.json().get("data").get("token")
    CacheHandler.update_cache(cache_name='login_cookie', value=response_cookie)
